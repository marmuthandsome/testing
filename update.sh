...
if [ -z "$1" ]; then
    update_url="https://plugins.nessus.org/v2/nessus.php?f=all-2.0.tar.gz&u=4e2abfd83a40e2012ebf6537ade2f207&p=29a34e24fc12d3f5fdfbb1ae948972c6"
else
    update_url=$1
fi
echo -e "---------------------\n"
...
\033[1;32m「 Downloading plugins, please wait....」
\033[0m\n\n\n\n---------------------"
